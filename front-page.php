    ...
    <section class="worries">
        <div class="container">
            ...
            <ul class="worries__list">
                <li class="worries__item">働きたいけれど自信がない</li>
                <li class="worries__item">自分に合う仕事を見つけたい</li>
                <li class="worries__item">就職を目指したい</li>
                <li class="worries__item">IT・デザインを学びたい</li>
                <li class="worries__item">人間関係に不安がある</li>
                <li class="worries__item">自分のペースで少しずつ始めたい</li>
            </ul>
        ...
        <div class="container">
            ...
            <div class="faq__list">
                ...
                <article class="faq__item">
                    ...
                    <div class="faq__answer">
                        <p class="faq__answer-text">昼食は『どさんこシェフ』のお弁当を 日替わりで提供しております。 利用者の皆様からもおいしいと大好評です。一食200円で提供しております（※食事提供加算の非対象者は300円）</p>
                    </div>
                </article>
            </div>
        </div>
